// Seeds an admin user and the 5 placeholder ICPs called for in PRD §8.2.
// Real ICP criteria/weights come from the Product Owner — these are illustrative.
...
async function main() {
  ...
  const { scoreLead } = await import("../src/lib/scoring");
